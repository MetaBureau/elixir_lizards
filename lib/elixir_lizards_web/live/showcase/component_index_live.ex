defmodule ElixirLizardsWeb.Showcase.ComponentIndexLive do
  @moduledoc """
  ...
  def mount(_params, _session, socket) do
    {:ok,
     socket
     |> assign(:page_title, "Component Libraries")
     |> assign(:daisyui_component_count, DaisyUI.ComponentDemoLive.component_count())
     |> assign(:chelekom_component_count, Chelekom.ComponentDemoLive.component_count())}
  end
      ...
      <div id="showcase-library-index">
            ...
            <div class="d-card-body">
              <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <.badge id="showcase-daisyui-count" variant="primary" size="sm">
                    {@daisyui_component_count} Components
                  </.badge>
                </div>
              </div>
            ...
            <div class="d-card-body">
              <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <.badge id="showcase-chelekom-count" variant="secondary" size="sm">
                    {@chelekom_component_count} Components
                  </.badge>
                </div>
              </div>
              <p class="text-base-content/70 mb-4">
        ...
        <div class="mt-12 p-6 bg-base-200 d-rounded-box">
          ...
          <div class="overflow-x-auto">
            <table id="showcase-comparison-table" class="d-table">
              <thead>
                <tr>
                  <th>Feature</th>
                  <th>DaisyUI</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td id="showcase-comparison-daisyui-count">
                    {@daisyui_component_count} components
                  </td>
                  <td id="showcase-comparison-chelekom-count">
                    {@chelekom_component_count} components
                  </td>
                </tr>
                <tr>
