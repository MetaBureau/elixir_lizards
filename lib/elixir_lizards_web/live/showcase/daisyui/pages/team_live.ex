defmodule ElixirLizardsWeb.Showcase.DaisyUI.Pages.TeamLive do
  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash}>
      ...
      <div class="mb-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div
            ...
            class="d-card bg-base-100 d-card-compact d-card-border border-base-300 hover:border-primary/50 transition-colors"
          >
      ...
      <%!-- Team Stats --%>
      <div class="bg-base-200 d-rounded-box p-8 mb-16">
      ...
      <%!-- Join Us CTA --%>
      <div class="text-center py-12 bg-gradient-to-r from-primary/10 to-secondary/10 d-rounded-box">
