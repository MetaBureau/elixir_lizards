  ...
  def render(assigns) do
    ...
    <div class="space-y-6">
      ...
      <div class="max-w-4xl mx-auto space-y-8">
        <div class="space-y-4">
          <h3 class="text-lg font-semibold">Basic Video</h3>
        ...
        <div class="space-y-4">
          <h3 class="text-lg font-semibold">Video with Thumbnail</h3>
          <Video.video
            ratio="video"
            rounded="large"
        ...
        <div class="space-y-4">
          <h3 class="text-lg font-semibold">Different Aspect Ratios</h3>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <p class="text-sm text-base-content/60 mb-2">16:9 (video)</p>
            ...
            <div>
              <p class="text-sm text-base-content/60 mb-2">4:3</p>
        ...
        <div class="space-y-4">
          ...
          <div class="space-y-4">
            <div>
              <p class="text-sm text-base-content/60 mb-2">Small width</p>
            ...
            <div>
              <p class="text-sm text-base-content/60 mb-2">Medium width</p>
        ...
        <div class="p-4 bg-base-200 rounded-lg">
          ...
          <pre class="text-sm overflow-x-auto"><code>&lt;Video.video ratio="video" rounded="medium" thumbnail="/images/poster.jpg" controls&gt;
