defmodule ElixirLizardsWeb.Showcase.Chelekom.Components.SidebarDemo do
  ...
  def render(assigns) do
    ...
    <div class="space-y-6">
      ...
      <Sidebar.sidebar id="chelekom-sidebar-left" size="medium" position="start" hide_position="left" class="!-translate-x-full">
        <div class="p-4">
      ...
      <Sidebar.sidebar id="chelekom-sidebar-right" size="medium" position="end" hide_position="right" color="primary" class="!translate-x-full">
        <div class="p-4">
