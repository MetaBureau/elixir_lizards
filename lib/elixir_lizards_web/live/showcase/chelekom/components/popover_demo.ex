  ...
  def render(assigns) do
    ...
    <div class="space-y-6">
      ...
      <div class="max-w-4xl mx-auto space-y-8">
        <div class="space-y-4">
          <h3 class="text-lg font-semibold">Basic Popover (Hover)</h3>
        ...
        <div class="space-y-4">
          <h3 class="text-lg font-semibold">Clickable Popovers</h3>
          <div class="flex flex-wrap gap-8 justify-center py-8">
        ...
        <div class="space-y-4">
          ...
          <div class="flex flex-wrap gap-4 justify-center py-8">
            <Popover.popover id="popover-color-1" variant="default" color="primary" position="bottom">
              <:trigger>
            ...
            <Popover.popover id="popover-color-3" variant="default" color="warning" position="bottom">
              <:trigger>
            ...
            <Popover.popover id="popover-color-4" variant="default" color="danger" position="bottom">
              <:trigger>
        ...
        <div class="space-y-4">
          <h3 class="text-lg font-semibold">Inline Popover</h3>
          <p class="py-4">
        ...
        <div class="p-4 bg-base-200 rounded-lg">
          ...
          <pre class="text-sm overflow-x-auto"><code>&lt;Popover.popover id="my-popover" clickable position="bottom"&gt;
    &lt;:trigger&gt;
