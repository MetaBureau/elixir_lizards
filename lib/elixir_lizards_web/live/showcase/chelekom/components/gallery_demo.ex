defmodule ElixirLizardsWeb.Showcase.Chelekom.Components.GalleryDemo do
  ...
  def render(assigns) do
    ~H"""
    <div id="gallery-demo" class="demo-component space-y-6">
      ...
      <div class="demo-content max-w-4xl mx-auto space-y-8">
        <div id="gallery-grid" class="demo-section space-y-4">
          <h3 class="demo-section-title text-lg font-semibold">Default Grid Layout</h3>
        ...
        <div id="gallery-masonry" class="demo-section space-y-4">
          <h3 class="demo-section-title text-lg font-semibold">Masonry Layout</h3>
          <div class="demo-box p-4 bg-base-100 border border-base-300 rounded-lg">
        ...
        <div id="gallery-animated" class="demo-section space-y-4">
          <h3 class="demo-section-title text-lg font-semibold">With Hover Animation</h3>
          <div class="demo-box p-4 bg-base-100 border border-base-300 rounded-lg">
        ...
        <div id="gallery-usage" class="demo-section demo-usage p-4 bg-base-200 rounded-lg">
          <h3 class="demo-section-title text-lg font-semibold mb-2">Usage Example</h3>
          <pre class="demo-code text-sm overflow-x-auto"><code>&lt;Gallery.gallery cols="three" gap="medium" animation="scale-up"&gt;
