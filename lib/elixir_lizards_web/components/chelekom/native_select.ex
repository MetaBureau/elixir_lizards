defmodule ElixirLizardsWeb.Components.Chelekom.NativeSelect do
  @moduledoc """
  The `ElixirLizardsWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `ElixirLizardsWeb.Components.NativeSelect`
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/native-select
  ...
  def select_option_group(assigns) do
    assigns =
      assign(assigns, :id, assigns[:id] || assigns[:label])
