defmodule ElixirLizardsWeb.Components.Chelekom.EmailField do
  @moduledoc """
  The `ElixirLizardsWeb.Components.EmailField` module provides a customizable email input field
