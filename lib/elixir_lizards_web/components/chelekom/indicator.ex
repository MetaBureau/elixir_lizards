defmodule ElixirLizardsWeb.Components.Chelekom.Indicator do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Indicator` module provides a versatile component for visually highlighting
