defmodule ElixirLizardsWeb.Components.Chelekom.MegaMenu do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.MegaMenu` module provides a customizable and interactive mega menu component
