defmodule ElixirLizardsWeb.Components.Chelekom.Jumbotron do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Jumbotron` module provides a versatile component for creating large,
