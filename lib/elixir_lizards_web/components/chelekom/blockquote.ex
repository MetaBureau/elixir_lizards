defmodule ElixirLizardsWeb.Components.Chelekom.Blockquote do
  @moduledoc """
  This module provides a versatile `ElixirLizardsWeb.Components.Chelekom.Blockquote` component for creating
