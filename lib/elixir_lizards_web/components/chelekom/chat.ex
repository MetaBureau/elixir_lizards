defmodule ElixirLizardsWeb.Components.Chelekom.Chat do
  @moduledoc """
  `ElixirLizardsWeb.Components.Chelekom.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
