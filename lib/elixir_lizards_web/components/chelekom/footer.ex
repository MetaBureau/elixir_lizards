defmodule ElixirLizardsWeb.Components.Chelekom.Footer do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Footer` module provides a customizable footer component for Phoenix applications,
