defmodule ElixirLizardsWeb.Components.Chelekom.Combobox do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
