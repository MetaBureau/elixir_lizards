defmodule ElixirLizardsWeb.Components.Chelekom.DeviceMockup do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.DeviceMockup` module provides a customizable component for displaying
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/device-mockup
  ...
  import ElixirLizardsWeb.Components.Chelekom.Image, only: [image: 1]
