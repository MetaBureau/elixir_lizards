defmodule ElixirLizardsWeb.Components.Chelekom.TableContent do
  @moduledoc """
  `ElixirLizardsWeb.Components.Chelekom.TableContent` is a component module designed to create flexible and dynamic
