defmodule ElixirLizardsWeb.Components.Chelekom.Sidebar do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Sidebar` module provides a versatile and customizable sidebar
