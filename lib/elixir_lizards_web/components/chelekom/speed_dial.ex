defmodule ElixirLizardsWeb.Components.Chelekom.SpeedDial do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.SpeedDial` module provides a versatile speed dial component for Phoenix
