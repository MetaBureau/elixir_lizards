defmodule ElixirLizardsWeb.Components.Chelekom.FileField do
  @moduledoc """
  The `ElixirLizardsWeb.Components.FileField` module provides a versatile and customizable component
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/file-field
  ...
  import ElixirLizardsWeb.Components.Chelekom.Progress, only: [progress: 1]
  import ElixirLizardsWeb.Components.Chelekom.Spinner, only: [spinner: 1]
