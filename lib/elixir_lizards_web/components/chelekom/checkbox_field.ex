defmodule ElixirLizardsWeb.Components.Chelekom.CheckboxField do
  @moduledoc """
  ElixirLizardsWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
