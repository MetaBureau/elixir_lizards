defmodule ElixirLizardsWeb.Components.Chelekom.ScrollArea do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
