defmodule ElixirLizardsWeb.Components.Chelekom.TelField do
  @moduledoc """
  The `ElixirLizardsWeb.Components.TelField` module provides a highly customizable telephone input field
