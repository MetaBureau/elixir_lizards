defmodule ElixirLizardsWeb.Components.Chelekom.SearchField do
  @moduledoc """
  The `ElixirLizardsWeb.Components.SearchField` module provides a highly customizable search input
