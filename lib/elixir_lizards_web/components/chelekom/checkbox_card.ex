defmodule ElixirLizardsWeb.Components.Chelekom.CheckboxCard do
  @moduledoc """
  The `ElixirLizardsWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
