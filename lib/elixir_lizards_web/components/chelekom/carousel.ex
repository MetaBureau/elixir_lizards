defmodule ElixirLizardsWeb.Components.Chelekom.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `ElixirLizardsWeb.Components.Chelekom.Carousel`
  project.
