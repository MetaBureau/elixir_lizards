defmodule ElixirLizardsWeb.Components.Chelekom.RangeField do
  @moduledoc """
  The `ElixirLizardsWeb.Components.RangeField` module provides a comprehensive range input field
