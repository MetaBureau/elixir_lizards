defmodule ElixirLizardsWeb.Components.Chelekom.ToggleField do
  @moduledoc """
  ElixirLizardsWeb.Components.ToggleField component renders a toggle field with customizable options.
