defmodule ElixirLizardsWeb.Components.Chelekom.Gallery do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Gallery` module provides a customizable gallery component for displaying
