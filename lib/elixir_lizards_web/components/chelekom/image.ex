defmodule ElixirLizardsWeb.Components.Chelekom.Image do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Image` module provides a component for rendering images in a Phoenix application.
