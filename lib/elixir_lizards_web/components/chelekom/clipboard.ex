defmodule ElixirLizardsWeb.Components.Chelekom.Clipboard do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
