defmodule ElixirLizardsWeb.Components.Chelekom.Stepper do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Stepper` module provides a flexible and interactive stepper component
  ...
  The `ElixirLizardsWeb.Components.Chelekom.Stepper` enhances user experience by providing a clear and concise representation
