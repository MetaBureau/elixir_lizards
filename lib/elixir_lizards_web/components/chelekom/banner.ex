defmodule ElixirLizardsWeb.Components.Chelekom.Banner do
  @moduledoc """
  ElixirLizardsWeb.Components.Chelekom.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
