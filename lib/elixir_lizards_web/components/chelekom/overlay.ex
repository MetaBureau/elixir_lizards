defmodule ElixirLizardsWeb.Components.Chelekom.Overlay do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Overlay` module provides a versatile overlay component for
  ...
  The `ElixirLizardsWeb.Components.Chelekom.Overlay` is perfect for creating modal backgrounds, loading screens,
