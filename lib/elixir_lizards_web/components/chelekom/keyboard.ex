defmodule ElixirLizardsWeb.Components.Chelekom.Keyboard do
  @moduledoc """
  The `ElixirLizardsWeb.Components.Chelekom.Keyboard` module provides a customizable keyboard component,
