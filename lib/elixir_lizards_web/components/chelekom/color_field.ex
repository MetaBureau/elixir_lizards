defmodule ElixirLizardsWeb.Components.Chelekom.ColorField do
  @moduledoc """
  The `ElixirLizardsWeb.Components.ColorField` module provides a reusable and customizable color
